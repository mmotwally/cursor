...
interface UserPermissionColumnSelectorProps {
...
const UserPermissionColumnSelector: React.FC<UserPermissionColumnSelectorProps> = ({
  columnVisibility,
...
export default UserPermissionColumnSelector; 